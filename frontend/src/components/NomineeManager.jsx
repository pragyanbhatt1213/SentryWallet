          ...
          <table className="w-full text-left mb-2 table-auto">
            <thead>
              <tr className="border-b">
                <th className="pr-4 pb-2 text-xs font-semibold text-gray-600 uppercase tracking-wider">Email</th>
                <th className="pr-4 pb-2 text-xs font-semibold text-gray-600 uppercase tracking-wider">Wallet Address</th>
                <th className="pr-4 pb-2 text-xs font-semibold text-gray-600 uppercase tracking-wider">Share (%)</th>
              </tr>
            </thead>
            <tbody>
              {nomineeData.map((nom, idx) => (
                <tr key={idx} className="border-t">
                  <td className="pr-4 py-2">{nom.email}</td>
                  <td className="pr-4 py-2 text-sm text-gray-600 font-mono truncate max-w-[180px]">{nom.address}</td>
                  <td className="pr-4 py-2">{nom.share}</td>
                </tr>
              ))}
            </tbody>
          </table>
